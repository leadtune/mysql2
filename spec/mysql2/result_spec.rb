...
describe Mysql2::Result do
  ...
  context "row data type mapping" do
    ...
    it "should return nil values for NULL and strings for everything else when :cast is disabled" do
      result = @client.query('SELECT null_test, tiny_int_test, bool_cast_test, int_test, date_test, enum_test FROM mysql2_test WHERE bool_cast_test = 1 LIMIT 1', :cache_rows => false, :cast => false).first
